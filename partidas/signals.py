        ...
        for user_pk in pk_set:
            ...
            publish_to_redis(
                f"notifications_user_{jogador.id}",
                {
                    ...
                    "mensagem": f'Você entrou na partida "{instance.titulo}".',
                    "conversa_url": "/feed/",
                    "timestamp": "agora",
                    "timestamp_iso": timezone.now().isoformat(),
                },
        ...
        for user_pk in pk_set:
            ...
            if instance.organizador_id != jogador.id:
                ...
                publish_to_redis(
                    f"notifications_user_{instance.organizador_id}",
                    {
                        ...
                        "remetente": jogador.username,
                        "foto_url": foto_url,
                        "mensagem": f'saiu da sua partida "{instance.titulo}".',
                        "conversa_url": "/feed/",
                        "timestamp": "agora",
                        "timestamp_iso": timezone.now().isoformat(),
                    },
            ...
            publish_to_redis(
                f"notifications_user_{jogador.id}",
                {
                    ...
                    "remetente": instance.organizador.username,
                    "foto_url": my_foto_url,
                    "mensagem": f'Você saiu da partida "{instance.titulo}".',
                    "conversa_url": "/feed/",
                    "timestamp": "agora",
                    "timestamp_iso": timezone.now().isoformat(),
                },
            ...
            if jogador.id != instance.organizador_id:
                publish_to_redis(
                    f"notifications_user_{jogador.id}",
                    {
                        ...
                        "remetente": instance.organizador.username,
                        "foto_url": foto_url,
                        "mensagem": f'A partida "{instance.titulo}" foi cancelada pelo organizador.',
                        "conversa_url": "/feed/",
                        "timestamp": "agora",
                        "timestamp_iso": timezone.now().isoformat(),
                    },
